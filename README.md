...
```bash
sudo apt install -y git && git clone https://github.com/josenarvaez54/aa-max-install.git autoatende && sudo chmod -R 777 ./autoatende && cd ./autoatende && sudo ./install_primaria
```
